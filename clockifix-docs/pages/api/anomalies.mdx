...
| Nullable fields declared as required | 27 unique fields | High — causes runtime validation failures |
...
| Spec divergences (unique fields) | 27 |
| Spec divergences (total across all array items) | 150 |
...
| `projectDefaultValues[].value` | `Record<string, unknown>` | `null` |
