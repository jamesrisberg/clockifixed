...
This section documents the Clockify REST API as defined in their [official OpenAPI 3.0.1 spec](https://docs.clockify.me/openapi.json). For the official interactive API reference, see [Clockify's API documentation](https://docs.clockify.me/).
