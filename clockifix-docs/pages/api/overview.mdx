...
This section documents the Clockify REST API as defined in their [official OpenAPI 3.0.1 spec](https://docs.clockify.me/openapi.json). For the interactive API reference, see [Clockify's API documentation](https://docs.clockify.me/) (their spec has circular schema references that prevent us from hosting a playground directly).

Clockifixed wraps this API with [unified types](/sdk/type-system), [runtime validation](/sdk/verification), and [documented anomalies](/api/anomalies) — so you can build on it with confidence.
